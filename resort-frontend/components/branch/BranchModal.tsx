    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative bg-black border border-white/10 rounded-2xl p-8 max-w-5xl w-full mx-6 max-h-[75vh] overflow-y-auto"
          >
            {/* Close button */}
            <button
              onClick={onClose}
            ...
            <div className="text-center mb-10">
              <p className="text-sm tracking-[0.35em] text-resort-gold mb-3">
                OUR DESTINATIONS
              </p>

              <h2 className="text-3xl md:text-4xl font-cinzel text-white">
                Choose Your Escape
              </h2>
            </div>
      ...
      bg-[radial-gradient(circle_at_bottom,rgba(212,175,55,0.15),transparent_60%)]"
                    ...
                    <div className="absolute bottom-0 p-5 text-white">
                      ...
                      <h3 className="text-xl font-semibold font-cinzel">
                        {branch.name}
                      </h3>
                    </div>
                  </div>
