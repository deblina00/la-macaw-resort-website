      ...
      <section className="bg-black text-white py-20">
        ...
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <h2 className="text-4xl font-serif mb-6 mt-10">
              Partner With Us
            </h2>
            ...
            <p className="text-gray-400 mb-10 leading-relaxed">
              ...
              dedicated support and customized packages tailored
              for travel agencies and corporate planners.
            </p>
          ...
          <div className="border border-white/10 bg-white/5 backdrop-blur p-10">
            ...
            <p className="text-gray-400 mb-8">
              Share your details and our team will reach out to
              discuss collaboration opportunities and tailored
